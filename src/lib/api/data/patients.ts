...
/* Sample data from reference/icu-mission-control.html.
   Two reconciliations against the Bed Overview roster (single source of truth):
   - Nadia Karim moved B-08 → B-09 (B-08 is an empty bed on the unit).
   - Beds B-10…B-15 added so every occupied bed can be opened in Mission
     Control; their vitals extend the Bed Overview samples. */
