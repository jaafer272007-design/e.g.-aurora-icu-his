...
import {
  IconAdmit, IconAlertTriangle, IconBed, IconDischarge, IconFlask, IconGrid, IconPill, IconSettings, IconStats,
} from './icons'

export type NavKey = 'dashboard' | 'beds' | 'orders' | 'labs' | 'admissions' | 'discharges' | 'alerts' | 'statistics' | 'settings'
